...
parser.add_argument('--dataset', default='special')
parser.add_argument('--runname', default='BS8-special-LSGAN-first')
...
def discriminator_loss(disc_real_output, disc_generated_output):
  disc_loss = tf.reduce_sum(tf.square(disc_real_output-1) + tf.square(disc_generated_output))/2
...
def train_step(input_image, target):
  ...
  #   tf.summary.scalar('gen_total_loss', gen_total_loss, step=0)
  #   tf.summary.scalar('gen_gan_loss', gen_gan_loss, step=0)
  #   tf.summary.scalar('gen_l1_loss', gen_l1_loss, step=0)
